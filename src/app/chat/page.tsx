...
const Chat = () => {
  ...
  const handleFileChange = (event:React.ChangeEvent<HTMLInputElement>) => {
    ...
    // You can handle file upload or preview logic here
    console.log("Selected file:", file);
    // sate of file create voli and do file upload management 
  };

  async function handelSubmit() {
    if (!message) return;
    addMessage({ role: "user", content: message, attachedFiles: [] });
      ...
      <div className="max-w-4xl w-full px-6">
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <div className="relative flex items-center gap-2 bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-full px-2 py-1 shadow-2xl hover:border-gray-600 transition-all duration-300 focus-within:border-purple-500">
            ...
            {/* Hidden input field for attachment */}
            <input
              type="file"
              accept=".pdf,image/*"
              ref={fileInputRef}
